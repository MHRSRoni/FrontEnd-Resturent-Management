    ...
    return (
        <section style={{ height: "calc(100vh - 80px)" }} className="text-center py-10 flex justify-center items-center">
            <div className="w-full md:w-3/4 lg:w-2/4 xl:w-1/3 mx-auto py-10 shadow-2xl">
                ...
                <div className="w-20 mx-auto h-0.5 mb-4 mt-0 bg-orange-500"></div>
                <form onSubmit={handleSubmit} className="mx-auto max-w-xs">
                    ...
                    <h3 className="mt-2">Already have an account? <span className="text-orange-500"><Link to="/sign-up">Login</Link></span></h3>
                </form>
            </div>
        </section>
